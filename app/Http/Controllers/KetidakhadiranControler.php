...
class KetidakhadiranControler extends Controller
{
    /**
      ...
      public function index(Request $request)
    {
              $startDate = $request->get('start_date', Carbon::now()->startOfMonth()->toDateString());
                ...
                return view('pages/Rekapitulasi/Ketidakhadiran', compact('rekap', 'kelasList', 'startDate', 'endDate', 'kelasFilter'));
    ...
    public function create(Request $request)
    {
            ...
            // Buat PDF
            $pdf = Pdf::loadView('pages.Rekapitulasi.ketidakhadiranpdf', [
                'rekap'       => $rekap,
                'startDate'   => $startDate,
                'endDate'     => $endDate,
            ...
            return $pdf->download("rekap_ketidakhadiran_{$kelasNama}_{$startDate}_{$endDate}.pdf");
    }
    /**
